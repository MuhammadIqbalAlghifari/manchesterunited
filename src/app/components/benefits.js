...
export default function Benefits() {
    ...
    const BenefitsData = [
        ...
        },
        {
            ...
            description:"We provide catagogues for our high quality products for football equipment",
            button: "Buy Product Now"
        },
        {
        ...
        },
        {
            ...
            description:"We offer a catalog to offer to people interested in football .",
            button: "Buy Product Now"
        },
        {
    ...
    return (
        <section className="bg-[#f5f5f5] w-full py-14" ref={ref}>
            ...
            <div className="flex flex-col items-center tersembunyi-fade relative bg-cover" style={{backgroundImage: 'url("/united shop.jpg")'}}>
