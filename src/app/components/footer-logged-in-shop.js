...
export default function FooterShop() {
    ...
    return (
        <footer className="z-10 w-full  transition duration-500 bg-[#121212] px-6 py-6 lg:py-12 lg:px-12" ref={ref}>
            <div className="tersembunyi-footer">
                <div className="flex justify-between items-start py-4">
                    <div id="footer-left" className="flex justify-start md:gap-5 gap-2 flex-col">
                        <h1 className="gap-2 lg:text-5xl md:text-3xl text-lg text-white transition duration-500" style={{fontFamily: 'Bebas Neue'}}>Manchester United</h1>
                        <p className="text-white lg:text-md md:text-sm sm:text-[9px] text-[7px] transition duration-500" style={{fontFamily: 'Roboto'}}>Glory Glory Manchester United</p>
                    </div>
                ...
                <hr style={{height: '3px', border: '10px'}} className="bg-white transition duration-500 lg:my-6 my-3"/>
                    <div className="flex justify-center items-center flex-col md:gap-5 gap-3 py-4 transition-all">
                        ...
                        <h1 className="lg:text-xs sm:text-[9px] text-[7px] text-white transition duration-500" style={{fontFamily: 'Roboto'}}> @ {currentYear} Manchester United. All Rights Reserved.</h1>
                    </div>
            </div>
        </footer>
    )
