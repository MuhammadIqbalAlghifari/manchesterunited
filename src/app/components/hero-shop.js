        ...
        <section className="w-full relative" ref={ref}>   
            ...
            <main className="flex flex-col lg:flex-row justify-center gap-10 px-6 items-center z-10 py-28 w-full lg:max-w-7xl mx-auto">
                <div id="hero-landing-left" className="max-w-lg lg:text-left text-center tersembunyi-hero">
                    <div className="text-white lg:text-8xl text-4xl py-2" style={{fontFamily: 'Bebas Neue'}}>welcome to manchester united shop</div>
                    <div className="text-white md:text-base text-sm py-2" style={{fontFamily: 'Roboto'}}>Step into the world of football at Manchester United Shop Center, where excellence meets style. Discover a curated selection of top-tier gear and apparel that empowers your journey to worldclass player.</div>
                ...
                <div id="hero-landing-right" className="flex gap-4 tersembunyi-hero">
                    <div id="hero left" className="bg-no-repeat shadow-black shadow-xl">
                        <img src="/united shop.jpg" alt="" className=" h-[500px] lg:max-w-3xl object-cover"/>
                    </div>
                </div>
            </main>
        </section>
